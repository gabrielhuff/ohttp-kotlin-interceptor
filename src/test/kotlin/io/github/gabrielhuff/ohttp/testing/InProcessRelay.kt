 ...
 * forwards the encapsulated body byte-for-byte to the configured gateway URL,
 * and returns the encapsulated response. It does not decrypt anything (per
 * RFC 9458 §3 — relays MUST NOT learn request contents).
 */
internal class InProcessRelay(
    ...
    fun lastForwardedRequestBytes(): ByteArray? = lastForwardedPayload.get()
